...
include::{snippets}/apply-history/request-fields.adoc[]
include::{snippets}/apply-history/curl-request.adoc[]
include::{snippets}/apply-history/http-response.adoc[]
include::{snippets}/apply-history/response-fields.adoc[]
include::{snippets}/apply-history/response-body.adoc[]
//operation::apply-history[snippets='request-fields,curl-request,http-response,response-fields,response-body']
